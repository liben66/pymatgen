...
class Incar(UserDict, MSONable):
    ...
    def proc_val(key: str, val: str) -> list | bool | float | int | str:
        ...
        as_is_str_keys = ("SYSTEM", "LATTICE_CONSTRAINTS")
...
class Kpoints(MSONable):
    ...
    def automatic_density(
        ...
        elif has_odd or is_hexagonal or is_face_centered or force_gamma:
    ...
    def automatic_density_by_vol(
        ...
        return cls.automatic_density(structure, kppa, force_gamma=force_gamma, comment=comment, force_mk=force_mk)
